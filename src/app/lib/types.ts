...
export interface Profile {
  ...
  deck_usage: Record<string, {order: number, count: number, wins: Record<number, number>, losses: Record<number, number>}>
  hand_usage: Record<string, {order: string; count: number}>
  high_scores: Record<string, {tot?: number; label: string; amt: number}>
  joker_usage: Record<string, {order: number, count: number, wins: Record<number, number>, losses: Record<number, number>}>
  name: string
  progress: {
  ...
  challenge_progress?: {completed: Record<string, boolean>, unlocked: Record<string, boolean>}
