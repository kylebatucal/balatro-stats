...
export default function Page() {
  ...
  const [buttonSound] = useSound('/sounds/button.ogg', { volume: 0.3, playbackRate: 0.95, soundEnabled: settings.soundEnabled.enabled })
  const [cardSound] = useSound('/sounds/paper1.ogg', { volume: 0.5, soundEnabled: settings.soundEnabled.enabled })
  const [chipSound] = useSound('/sounds/chips1.ogg', { volume: 0.3, soundEnabled: settings.soundEnabled.enabled })
  const [tarotSound] = useSound('/sounds/tarot2.ogg', { volume: 0.66, soundEnabled: settings.soundEnabled.enabled })
  const sounds = {
