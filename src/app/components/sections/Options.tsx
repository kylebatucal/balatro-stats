...
function minifySettings(settings: Record<string, {label: string, enabled: boolean}>) {
      ...
      <div className={styles.options}>
        ...
        <div className={styles.section}>
          ...
          <div style={{
            ...
            <ul>
              Fan website by Kyle Batucal
            </ul>
            <ul>
              <a className={styles.link} href='https://www.playbalatro.com/'>Balatro</a> created by LocalThunk
            </ul>
            <ul>
              <a className={styles.link} href='https://managore.itch.io/m6x11'>m6x11.tff</a> font by Daniel Linssen
            </ul>
          </div>
        </div>
